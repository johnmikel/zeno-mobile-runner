...
MAX_BUNDLE_FILE_COUNT = 4096
MAX_BUNDLE_DIRECTORY_COUNT = 4096
MAX_BUNDLE_INSPECTED_BYTES = 256 * 1024 * 1024
MAX_STRUCTURED_JSON_BYTES = 2 * 1024 * 1024
MAX_JSON_INTEGER_DIGITS = 640
MAX_JSON_FLOAT_CHARACTERS = 1024
MAX_JSONL_LINE_BYTES = 256 * 1024
MAX_LIFECYCLE_EVENT_STREAM_BYTES = 32 * 1024 * 1024
MAX_CONTEXT_SIBLING_COUNT = 64
MAX_CONTEXT_SIBLING_AGGREGATE_BYTES = 64 * 1024 * 1024
MAX_SANITIZATION_SECRET_COUNT = 64
MAX_SANITIZATION_ROOT_COUNT = 8
MAX_SANITIZATION_TERM_BYTES = 128 * 1024
MAX_SANITIZATION_SECRET_TOTAL_BYTES = 256 * 1024
MAX_SANITIZATION_ROOT_TOTAL_BYTES = 64 * 1024
MAX_SANITIZATION_SECRET_NAME_COUNT = 64
MAX_SANITIZATION_SECRET_NAMES_BYTES = 64 * 1024
MAX_COMMAND_ARGV_COUNT = 256
MAX_COMMAND_ARG_BYTES = 16 * 1024
MAX_COMMAND_ARGV_BYTES = 64 * 1024
MAX_SESSION_STATE_BYTES = 16 * 1024
MAX_TERMINAL_INTENT_BYTES = 32 * 1024
MAX_COMMAND_STATE_BYTES = 256 * 1024
MAX_TERMINAL_SECONDARY_DIAGNOSTICS = 8
MAX_ACTIVE_COMMANDS = 8
MAX_SESSION_COMMANDS = 1024
MAX_RUN_SEGMENT_BYTES = 128
MAX_TRANSACTION_TARGET_COUNT = MAX_BUNDLE_FILE_COUNT
MAX_TRANSACTION_REQUIRED_DIRECTORY_COUNT = MAX_BUNDLE_FILE_COUNT
MAX_TRANSACTION_REQUEST_BYTES = 4 * 1024 * 1024
MAX_TRANSACTION_TARGET_AGGREGATE_BYTES = 64 * 1024 * 1024
MAX_TRANSACTION_JOURNAL_BYTES = 96 * 1024 * 1024
MAX_PENDING_TRANSACTION_COUNT = 64
MAX_PENDING_TRANSACTION_BYTES = 128 * 1024 * 1024
MAX_TRANSACTION_DIRECTORY_ENTRY_COUNT = 128
MAX_TRANSACTION_TARGET_PARENT_ENTRY_COUNT = (
    MAX_BUNDLE_FILE_COUNT
    + max(MAX_BUNDLE_DIRECTORY_COUNT, MAX_BUNDLE_FILE_COUNT)
    - 1
    + MAX_TRANSACTION_DIRECTORY_ENTRY_COUNT
)
MAX_AGGREGATE_SUMMARY_COUNT = 1000
MAX_AGGREGATE_INSPECTED_BYTES = 64 * 1024 * 1024
MAX_EXTERNAL_REMEDIATION_BYTES = 4096
_BUNDLE_SCAN_CHUNK_BYTES = 64 * 1024
_BUNDLE_SCAN_OVERLAP_BYTES = 64 * 1024
...
__all__ = (
    ...
    "EVIDENCE_MUTATION_REQUIREMENT",
    "MAX_BUNDLE_FILE_COUNT",
    "MAX_BUNDLE_DIRECTORY_COUNT",
    "MAX_BUNDLE_INSPECTED_BYTES",
    "MAX_STRUCTURED_JSON_BYTES",
    "MAX_JSON_INTEGER_DIGITS",
    "MAX_JSON_FLOAT_CHARACTERS",
    "MAX_JSONL_LINE_BYTES",
    "MAX_LIFECYCLE_EVENT_STREAM_BYTES",
    "MAX_CONTEXT_SIBLING_COUNT",
    "MAX_CONTEXT_SIBLING_AGGREGATE_BYTES",
    "MAX_SANITIZATION_SECRET_COUNT",
    "MAX_SANITIZATION_ROOT_COUNT",
    "MAX_SANITIZATION_TERM_BYTES",
    "MAX_SANITIZATION_SECRET_TOTAL_BYTES",
    "MAX_SANITIZATION_ROOT_TOTAL_BYTES",
    "MAX_SANITIZATION_SECRET_NAME_COUNT",
    "MAX_SANITIZATION_SECRET_NAMES_BYTES",
    ...
    "MAX_TRANSACTION_TARGET_COUNT",
    "MAX_TRANSACTION_REQUIRED_DIRECTORY_COUNT",
    "MAX_TRANSACTION_REQUEST_BYTES",
    "MAX_TRANSACTION_TARGET_AGGREGATE_BYTES",
    "MAX_TRANSACTION_JOURNAL_BYTES",
    "MAX_PENDING_TRANSACTION_COUNT",
    "MAX_PENDING_TRANSACTION_BYTES",
    "MAX_TRANSACTION_DIRECTORY_ENTRY_COUNT",
    "MAX_TRANSACTION_TARGET_PARENT_ENTRY_COUNT",
    "MAX_AGGREGATE_SUMMARY_COUNT",
    "MAX_AGGREGATE_INSPECTED_BYTES",
    "MAX_EXTERNAL_REMEDIATION_BYTES",
    "_BUNDLE_SCAN_CHUNK_BYTES",
    "_BUNDLE_SCAN_OVERLAP_BYTES",
    "COMPARABILITY_FIELDS",
    "SUPERVISOR_FAILURE_CODES",
    "SUPERVISOR_ONLY_FAILURE_CODES",
    "_ERROR_GROUPS",

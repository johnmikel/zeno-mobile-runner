...
const rpc_kill = [_][]const u8{};
const mcp_kill = [_][]const u8{};
...
const rpc_long_press = [_][]const u8{};
const mcp_long_press = [_][]const u8{};

const json_double_tap = [_][]const u8{"doubleTap"};
const yaml_double_tap = [_][]const u8{"doubleTapOn"};
const rpc_double_tap = [_][]const u8{};
const mcp_double_tap = [_][]const u8{};
...
const rpc_press_key = [_][]const u8{};
const mcp_press_key = [_][]const u8{};
...
const rpc_assert_none_visible = [_][]const u8{};
const mcp_assert_none_visible = [_][]const u8{};
...
const rpc_when_visible = [_][]const u8{};
const mcp_when_visible = [_][]const u8{};

const json_repeat = [_][]const u8{"repeat"};
const yaml_repeat = [_][]const u8{"repeat"};
const rpc_repeat = [_][]const u8{};
const mcp_repeat = [_][]const u8{};

const json_retry = [_][]const u8{"retry"};
const yaml_retry = [_][]const u8{"retry"};
const rpc_retry = [_][]const u8{};
const mcp_retry = [_][]const u8{};

const json_run_flow = [_][]const u8{"runFlow"};
const yaml_run_flow = [_][]const u8{"runFlow"};
const rpc_run_flow = [_][]const u8{};
const mcp_run_flow = [_][]const u8{};
...
const rpc_sleep = [_][]const u8{};
const mcp_sleep = [_][]const u8{};

const json_location = [_][]const u8{"setLocation"};
const yaml_location = [_][]const u8{"setLocation"};
const rpc_location = [_][]const u8{};
const mcp_location = [_][]const u8{};

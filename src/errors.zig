...
pub fn classify(err: anyerror) PublicError {
    return switch (err) {
        ...
        error.MissingOutcomeFile => .{ .code = "cli.missing_outcome_file", .message = "missing run outcome path" },
        error.MissingIosShimMode => .{ .code = "cli.missing_ios_shim_mode", .message = "missing iOS shim provenance mode" },
        error.MissingRunEvidenceRoot => .{ .code = "config.invalid", .message = "ZMR_RUN_EVIDENCE_ROOT is required for run outcomes" },
        ...
        error.UnsupportedIosShimMode => .{ .code = "config.invalid", .message = "unsupported iOS shim provenance mode" },
        error.IosShimPathRequired => .{ .code = "config.invalid", .message = "the selected iOS shim mode requires a shim path" },
        error.IosShimPathForbidden => .{ .code = "config.invalid", .message = "disabled iOS shim mode forbids a shim path" },
        error.InvalidOutcomePath => .{ .code = "config.invalid", .message = "run outcome path must be under run-outcomes" },
        error.OutcomeArtifactOutsideAttempt => .{ .code = "config.invalid", .message = "run outcome artifact is outside the evidence attempt" },

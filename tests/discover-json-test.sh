...
{"schemaVersion":1,"runnerVersion":"0.2.14","protocolVersion":"2026-04-28","scenarioName":"agent discovery","appId":"com.example.mobiletest","status":"passed","startedAtMs":1,"endedAtMs":2,"durationMs":1,"failedStepIndex":null,"error":null,"eventsPath":"events.jsonl","artifactsDir":"artifacts","eventCount":3,"snapshotCount":1,"partialFailureCount":0,"reportPath":null}
JSON

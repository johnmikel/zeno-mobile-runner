...
const tool_list_json =
    ...
    "{\"name\":\"launch_app\",\"description\":\"Launch the configured app on the selected device, optionally applying imported-flow launch options.\",\"inputSchema\":{\"type\":\"object\",\"additionalProperties\":false,\"properties\":{\"appId\":{\"type\":\"string\"},\"stopApp\":{\"type\":\"boolean\"},\"clearState\":{\"type\":\"boolean\"},\"clearKeychain\":{\"type\":\"boolean\"},\"arguments\":{\"type\":\"object\",\"additionalProperties\":{\"type\":[\"string\",\"boolean\",\"integer\",\"number\"]}}}}}," ++

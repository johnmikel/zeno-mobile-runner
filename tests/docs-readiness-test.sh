...
require_grep 'Current release: `0.2.11` developer preview' README.md
...
require_grep 'Current release status is `0.2.11`' FEATURES.md
...
require_grep '0.2.11' CHANGELOG.md

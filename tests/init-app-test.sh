...
grep -q 'zmr inspect --json --dir .' "$TMPDIR/app/.zmr/AGENTS.md"
...
grep -q 'zmr discover --from-trace traces/zmr-agent --out .zmr/discovered/replay-smoke.json --include-actions --validate --json' "$TMPDIR/app/.zmr/AGENTS.md"
...
grep -q 'zmr run .zmr/android-smoke.json --device emulator-5554 --trace-dir traces/zmr-android --ensure-device' "$TMPDIR/app/.zmr/AGENTS.md"
grep -q 'zmr report traces/zmr-android --out traces/zmr-android/report.html --junit traces/zmr-android/junit.xml' "$TMPDIR/app/.zmr/AGENTS.md"
...
grep -q 'traces/zmr-android-reliability/report.html --junit traces/zmr-android-reliability/junit.xml' "$TMPDIR/app/.zmr/AGENTS.md"
grep -q 'zmr run .zmr/ios-smoke.json --platform ios --device booted --trace-dir traces/zmr-ios --ensure-device' "$TMPDIR/app/.zmr/AGENTS.md"
grep -q 'zmr report traces/zmr-ios --out traces/zmr-ios/report.html --junit traces/zmr-ios/junit.xml' "$TMPDIR/app/.zmr/AGENTS.md"
...
grep -q 'traces/zmr-ios-reliability/report.html --junit traces/zmr-ios-reliability/junit.xml' "$TMPDIR/app/.zmr/AGENTS.md"
...
grep -q '"androidReport": "zmr report traces/zmr-android --out traces/zmr-android/report.html --junit traces/zmr-android/junit.xml"' "$TMPDIR/app/.zmr/config.json"
grep -q '"androidReliability": "export ZMR_BIN=\\"${ZMR_BIN:-zmr}\\"; zmr-benchmark --zmr .zmr/android-smoke.json --device emulator-5554 --app-id com.example.bootstrap --runs 20 --trace-root traces/zmr-android-reliability --min-pass-rate 100 --max-failures 0 --max-p95-ms 30000 && \\"$ZMR_BIN\\" report traces/zmr-android-reliability --out traces/zmr-android-reliability/report.html --junit traces/zmr-android-reliability/junit.xml"' "$TMPDIR/app/.zmr/config.json"
grep -q '"iosReport": "zmr report traces/zmr-ios --out traces/zmr-ios/report.html --junit traces/zmr-ios/junit.xml"' "$TMPDIR/app/.zmr/config.json"
grep -q '"iosReliability": "export ZMR_BIN=\\"${ZMR_BIN:-zmr}\\"; zmr-benchmark --zmr .zmr/ios-smoke.json --platform ios --device booted --app-id com.example.bootstrap --xcrun xcrun --runs 20 --trace-root traces/zmr-ios-reliability --min-pass-rate 100 --max-failures 0 --max-p95-ms 45000 && \\"$ZMR_BIN\\" report traces/zmr-ios-reliability --out traces/zmr-ios-reliability/report.html --junit traces/zmr-ios-reliability/junit.xml"' "$TMPDIR/app/.zmr/config.json"
...
grep -q '"smokeCommands":\["zmr run '"$TMPDIR"'/json-app/.zmr/android-smoke.json --device emulator-5554 --trace-dir '"$TMPDIR"'/json-app/traces/zmr-android --ensure-device","zmr run '"$TMPDIR"'/json-app/.zmr/ios-smoke.json --platform ios --device booted --trace-dir '"$TMPDIR"'/json-app/traces/zmr-ios --ensure-device"\]' "$TMPDIR/init.json"

...
run "python3 -m compileall -q scripts/run_evidence_lib scripts/run_evidence.py scripts/finalize_workflow_evidence.py"
...
run "bash tests/react-native-expo-demo-app-script-test.sh"
...
run "bash tests/inspect-json-test.sh"

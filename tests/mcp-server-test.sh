...
{"jsonrpc":"2.0","id":6,"method":"tools/call","params":{"name":"semantic_snapshot","arguments":{}}}
{"jsonrpc":"2.0","id":7,"method":"tools/call","params":{"name":"wait_visible","arguments":{"selector":{"text":"Sample landing."},"timeoutMs":1000}}}
{"jsonrpc":"2.0","id":8,"method":"tools/call","params":{"name":"wait_not_visible","arguments":{"selector":{"text":"Missing toast"},"timeoutMs":1000}}}
{"jsonrpc":"2.0","id":9,"method":"tools/call","params":{"name":"wait_any","arguments":{"selectors":[{"text":"Missing toast"},{"text":"Dashboard"}],"timeoutMs":1000}}}
{"jsonrpc":"2.0","id":10,"method":"tools/call","params":{"name":"swipe","arguments":{"x1":500,"y1":900,"x2":500,"y2":300,"durationMs":250}}}
{"jsonrpc":"2.0","id":11,"method":"tools/call","params":{"name":"hide_keyboard","arguments":{}}}
{"jsonrpc":"2.0","id":12,"method":"tools/call","params":{"name":"erase_text","arguments":{"selector":{"id":"email-login-email-input"},"maxChars":12}}}
{"jsonrpc":"2.0","id":13,"method":"tools/call","params":{"name":"scroll_until_visible","arguments":{"selector":{"text":"Invite a teammate"},"direction":"down","timeoutMs":1000}}}
{"jsonrpc":"2.0","id":14,"method":"tools/call","params":{"name":"assert_visible","arguments":{"selector":{"text":"Sample landing."},"timeoutMs":1000}}}
{"jsonrpc":"2.0","id":15,"method":"tools/call","params":{"name":"assert_not_visible","arguments":{"selector":{"text":"Missing toast"},"timeoutMs":1000}}}
{"jsonrpc":"2.0","id":16,"method":"tools/call","params":{"name":"assert_healthy","arguments":{"timeoutMs":1000}}}
{"jsonrpc":"2.0","id":17,"method":"tools/call","params":{"name":"scenario_validate","arguments":{"path":"examples/demo-fake.json"}}}
{"jsonrpc":"2.0","id":18,"method":"tools/call","params":{"name":"stop_app","arguments":{}}}
JSONL
...
semantic_text = rows[5]["result"]["content"][0]["text"]
...
scroll_text = rows[12]["result"]["content"][0]["text"]
...
validate_text = rows[16]["result"]["content"][0]["text"]
...
stop_text = rows[17]["result"]["content"][0]["text"]
